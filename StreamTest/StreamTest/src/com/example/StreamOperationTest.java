...
public class StreamOperationTest {
    ...
    public static void main(String[] args) {        
        ...
        Function<Person,Gender> genderChange=p->(p.getGender()==Gender.MALE ? Gender.FEMALE:Gender.MALE);
        Consumer<Gender> genderToString = p->p.toString();
        personList.parallelStream().
        					map(genderChange).
        					forEach(genderToString);
